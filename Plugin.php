...
class Markdown_Plugin implements Typecho_Plugin_Interface
{
    ...
    public static function config(Typecho_Widget_Helper_Form $form)
    {
        ...
        $elementCDNSource = new Typecho_Widget_Helper_Form_Element_Radio('cdn_source', array_combine(array_keys(self::CDN_SOURCE_MERMAID), array_map('_t', array_keys(self::CDN_SOURCE_MERMAID))), self::CDN_SOURCE_DEFAULT, _t('Mermaid 和 MathJax 的 CDN 源'), _t('国内用户可以选择 bytedance 或 bootcdn'));
